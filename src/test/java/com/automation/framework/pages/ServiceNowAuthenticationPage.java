...
public class ServiceNowAuthenticationPage {
    ...
    public void login(String username, String password) {
        ...
        WebElement userField = driver.findElement(ServiceNowAuthenticationLocators.USERNAME);
        userField.clear();
        userField.sendKeys(username);

        WebElement passField = driver.findElement(ServiceNowAuthenticationLocators.PASSWORD);
        passField.clear();
