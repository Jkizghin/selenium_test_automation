...
public class GeneralCloudServicesSubmittedRequestPage extends UiActions {

        public GeneralCloudServicesSubmittedRequestPage(WebDriver driver) {
                super(driver);
        }
        ...
        public void fillAndSubmitRequest(String requestedFor,
                ...
                type(GeneralCloudServicesSubmittedRequestLocators.SHORT_DESCRIPTION, shortDescription);
                type(GeneralCloudServicesSubmittedRequestLocators.ADDITIONAL_COMMENTS, additionalComments);

                wait.until(ExpectedConditions.elementToBeClickable(
                                GeneralCloudServicesSubmittedRequestLocators.SUBMIT_BUTTON));

                click(GeneralCloudServicesSubmittedRequestLocators.SUBMIT_BUTTON);
        ...
        private void typeRequestedFor(String name) {
                ...
                WebElement dropdown = wait.until(
                                ExpectedConditions.elementToBeClickable(
                                                GeneralCloudServicesSubmittedRequestLocators.REQUESTED_FOR_DROPDOWN));
        ...
        public String getCreatedRitmNumber() {
                String ritm = wait.until(
                                ExpectedConditions.visibilityOfElementLocated(
                                                GeneralCloudServicesSubmittedRequestLocators.CREATED_RITM))
                                .getText().trim();
                return ritm;
